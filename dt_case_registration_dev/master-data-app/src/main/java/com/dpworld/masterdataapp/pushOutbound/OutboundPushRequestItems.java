...
public class OutboundPushRequestItems {
	...
	private String outbReferenceNumber;
	...
	public String getOutbReferenceNumber() {
		return outbReferenceNumber;
	}

	public void setOutbReferenceNumber(String outbReferenceNumber) {
		this.outbReferenceNumber = outbReferenceNumber;
	}
