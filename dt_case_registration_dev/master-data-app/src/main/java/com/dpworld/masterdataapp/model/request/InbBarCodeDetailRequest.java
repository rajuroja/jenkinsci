...
public class InbBarCodeDetailRequest {
	...
	public String toString() {
		return "InbBarCodeDetailRequest [inbBarcodeDetails=" + inbBarcodeDetails + ", barCodeId=" + barCodeId + ", pallet=" + pallet + ", palletQuantity=" + palletQuantity + ", palletNetWeight="
				+ palletNetWeight + ", carton=" + carton + ", cartonQuantity=" + cartonQuantity + ", cartonNetWeight=" + cartonNetWeight + ", pieces=" + pieces + ", piecesQuantity=" + piecesQuantity
				+ ", piecesNetWeight=" + piecesNetWeight + "]";
	}
