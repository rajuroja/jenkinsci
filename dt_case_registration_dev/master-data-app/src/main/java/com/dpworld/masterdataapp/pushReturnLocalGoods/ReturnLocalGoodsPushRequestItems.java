...
public class ReturnLocalGoodsPushRequestItems {
	...
	@XmlElement(name = "returnlocalgoods_Reference_Number")
	private String returnLocalGoodsReferenceNumber;
	...
	public String getReturnLocalGoodsReferenceNumber() {
		return returnLocalGoodsReferenceNumber;
	}

	public void setReturnLocalGoodsReferenceNumber(String returnLocalGoodsReferenceNumber) {
		this.returnLocalGoodsReferenceNumber = returnLocalGoodsReferenceNumber;
	}
	...
	public String toString() {
		return "ReturnLocalGoodsPushRequestItems [arrivedFrom=" + arrivedFrom + ", marketType=" + marketType + ", arrivalDate=" + arrivalDate + ", modeofTransport=" + modeofTransport
				+ ", voyageNumber=" + voyageNumber + ", carrier=" + carrier + ", inbDeclarationNumber=" + inbDeclarationNumber + ", declarationType=" + declarationType + ", localGoodsPassNumber="
				+ localGoodsPassNumber + ", consigneeName=" + consigneeName + ", businessCode=" + businessCode + ", hsCode=" + hsCode + ", hsCodeDescription=" + hsCodeDescription + ", skuBarcode="
				+ skuBarcode + ", packageType=" + packageType + ", pallet=" + pallet + ", quantity=" + quantity + ", weight=" + weight + ", carton=" + carton + ", countryOfManufacture="
				+ countryOfManufacture + ", packageDescription=" + packageDescription + ", goodsCondition=" + goodsCondition + ", permit=" + permit + ", authority=" + authority + ", invoiceNumber="
				+ invoiceNumber + ", invoiceDate=" + invoiceDate + ", currency=" + currency + ", cifValue=" + cifValue + ", customsDeclaration=" + customsDeclaration + ", certificateOfOrigin="
				+ certificateOfOrigin + ", commercialInvoice=" + commercialInvoice + ", packingList=" + packingList + ", returnLocalGoodsReferenceNumber=" + returnLocalGoodsReferenceNumber
				+ ", outboundDeclarationNumber=" + outboundDeclarationNumber + "]";
	}
