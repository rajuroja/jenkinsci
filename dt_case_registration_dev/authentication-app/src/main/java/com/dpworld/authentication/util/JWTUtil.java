package com.dpworld.authentication.util;
...
/**
 * @author INTECH Creative Services Pvt Ltd This class is used for JWT token
 *         management like create token ,verify etc.
 *
 */
@Component
public class JWTUtil {
	...
	private String createToken(Map<String, Object> claims, org.springframework.security.core.Authentication authentication) {
